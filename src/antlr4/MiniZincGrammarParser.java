...
public class MiniZincGrammarParser extends Parser {
	...
	public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, T__7 = 8, T__8 = 9,
			...
			T__81 = 82, T__82 = 83, T__83 = 84, STRING = 85, ESC = 86, SINGLE_LINE_COMMENT = 87, ID = 88, NAT = 89,
			WS = 90, BOOL = 91;
	public static final int RULE_model = 0, RULE_stat = 1, RULE_decl = 2, RULE_vardecl = 3, RULE_pardecl = 4,
			RULE_table = 5, RULE_constraint = 6, RULE_var = 7, RULE_output = 8, RULE_solve = 9, RULE_parameter = 10,
			RULE_include = 11, RULE_init = 12, RULE_predicate = 13, RULE_function = 14, RULE_qualName = 15,
			RULE_varmark = 16, RULE_extendsmark = 17, RULE_opOrID = 18, RULE_satisfy = 19, RULE_optimize = 20,
			RULE_maximize = 21, RULE_minimize = 22, RULE_annotation = 23, RULE_modeAnnotation = 24, RULE_intS = 25,
			RULE_boolS = 26, RULE_setS = 27, RULE_seqS = 28, RULE_restS = 29, RULE_varchoice = 30,
			RULE_constrainchoice = 31, RULE_constr = 32, RULE_scons = 33, RULE_tcons = 34, RULE_typename = 35,
			RULE_typeset = 36, RULE_vararray = 37, RULE_pararray = 38, RULE_dimensions = 39, RULE_typedata = 40,
			RULE_expr = 41, RULE_boolVal = 42, RULE_op = 43, RULE_boolOp = 44, RULE_arithOp = 45, RULE_arithOp2 = 46,
			RULE_qualBoolOp = 47, RULE_qualArithOp = 48, RULE_boolComplexExpr = 49, RULE_boolExpr = 50,
			RULE_operand = 51, RULE_qualified = 52, RULE_arithComplexExpr = 53, RULE_arithExpr = 54, RULE_notExpr = 55,
			RULE_minusExpr = 56, RULE_predOrUnionExpr = 57, RULE_onesection = 58, RULE_twosections = 59,
			RULE_rbracketExpr = 60, RULE_idexpr = 61, RULE_stringExpr = 62, RULE_infixOp = 63, RULE_infixSetOp = 64,
			RULE_arrayaccess = 65, RULE_caseExpr = 66, RULE_caseBranch = 67, RULE_listExpr = 68, RULE_oneDimList = 69,
			RULE_simpleList = 70, RULE_simpleNonEmptyList = 71, RULE_guardedList = 72, RULE_multiDimList = 73,
			RULE_nonEmptyListElems = 74, RULE_listValue = 75, RULE_inDecl = 76, RULE_whereCond = 77, RULE_letExpr = 78,
			RULE_letDecl = 79, RULE_ifExpr = 80, RULE_bodyIf = 81, RULE_elseS = 82, RULE_elseifS = 83, RULE_setVal = 84,
			RULE_setExpr = 85, RULE_bracketExpr = 86, RULE_guardedSet = 87, RULE_commaList = 88, RULE_guard = 89,
			RULE_range = 90, RULE_fromR = 91, RULE_toR = 92, RULE_rint = 93, RULE_rfloat = 94, RULE_rbool = 95,
			RULE_integer = 96, RULE_real = 97, RULE_string = 98;
	public static final String[] ruleNames = { "model", "stat", "decl", "vardecl", "pardecl", "table", "constraint",
			"var", "output", "solve", "parameter", "include", "init", "predicate", "function", "qualName", "varmark",
			"extendsmark", "opOrID", "satisfy", "optimize", "maximize", "minimize", "annotation", "modeAnnotation",
			"intS", "boolS", "setS", "seqS", "restS", "varchoice", "constrainchoice", "constr", "scons", "tcons",
			"typename", "typeset", "vararray", "pararray", "dimensions", "typedata", "expr", "boolVal", "op", "boolOp",
			"arithOp", "arithOp2", "qualBoolOp", "qualArithOp", "boolComplexExpr", "boolExpr", "operand", "qualified",
			"arithComplexExpr", "arithExpr", "notExpr", "minusExpr", "predOrUnionExpr", "onesection", "twosections",
			"rbracketExpr", "idexpr", "stringExpr", "infixOp", "infixSetOp", "arrayaccess", "caseExpr", "caseBranch",
			"listExpr", "oneDimList", "simpleList", "simpleNonEmptyList", "guardedList", "multiDimList",
			"nonEmptyListElems", "listValue", "inDecl", "whereCond", "letExpr", "letDecl", "ifExpr", "bodyIf", "elseS",
			"elseifS", "setVal", "setExpr", "bracketExpr", "guardedSet", "commaList", "guard", "range", "fromR", "toR",
			"rint", "rfloat", "rbool", "integer", "real", "string" };

	private static final String[] _LITERAL_NAMES = { null, "';'", "'='", "'table'", "'constraint'", "':'", "'output'",
			"'('", "')'", "'solve'", "'par'", "'include'", "'predicate'", "','", "'function'", "'var'", "'extends'",
			"'satisfy'", "'maximize'", "'minimize'", "'::'", "'int_search'", "'bool_search'", "'set_search'",
			"'seq_search'", "'['", "']'", "'complete'", "'input_order'", "'first_fail'", "'smallest'", "'indomain'",
			"'indomain_min'", "'indomain_median'", "'indomain_random'", "'indomain_split'", "'set'", "'of'", "'array'",
			"'int'", "'_'", "'/\\'", "'\\/'", "'xor'", "'->'", "'<-'", "'<->'", "'=='", "'!='", "'<'", "'>'", "'>='",
			"'<='", "'in'", "'like'", "'*'", "'/'", "'div'", "'mod'", "'+'", "'-'", "'.'", "'not'", "'`'",
			"'intersect'", "'union'", "'case'", "'endcase'", "'-->'", "'++'", "'|'", "'[|'", "'|]'", "'where'", "'let'",
			"'{'", "'}'", "'if'", "'then'", "'else'", "'endif'", "'elseif'", "'..'", "'float'", "'bool'" };
	private static final String[] _SYMBOLIC_NAMES = { null, null, null, null, null, null, null, null, null, null, null,
			null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
			null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
			null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
			null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
			null, null, "STRING", "ESC", "SINGLE_LINE_COMMENT", "ID", "NAT", "WS", "BOOL" };
			...
			enterOuterAlt(_localctx, 1);
			{
				...
				do {
					...
					_la = _input.LA(1);
						...
						&& ((1L << _la) & ((1L << T__2) | (1L << T__3) | (1L << T__5) | (1L << T__6) | (1L << T__8)
								| (1L << T__9) | (1L << T__10) | (1L << T__11) | (1L << T__13) | (1L << T__14)
								| (1L << T__24) | (1L << T__35) | (1L << T__37) | (1L << T__38) | (1L << T__59))) != 0)
						|| ((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & ((1L << (T__73 - 74))
								| (1L << (T__76 - 74)) | (1L << (T__82 - 74)) | (1L << (T__83 - 74))
								| (1L << (STRING - 74)) | (1L << (ID - 74)) | (1L << (NAT - 74)))) != 0));
			}
	...
	public static class TableContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).enterTable(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).exitTable(this);
		}
	}
	...
	public final PredicateContext predicate() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				setState(290);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__6) | (1L << T__9) | (1L << T__14) | (1L << T__24)
						| (1L << T__35) | (1L << T__37) | (1L << T__38) | (1L << T__59))) != 0)
						|| ((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & ((1L << (T__73 - 74))
								| (1L << (T__76 - 74)) | (1L << (T__82 - 74)) | (1L << (T__83 - 74))
								| (1L << (STRING - 74)) | (1L << (ID - 74)) | (1L << (NAT - 74)))) != 0)) {
					{
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				if (!((((_la) & ~0x3f) == 0 && ((1L << _la)
						& ((1L << T__30) | (1L << T__31) | (1L << T__32) | (1L << T__33) | (1L << T__34))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
	...
	public final BoolOpContext boolOp() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if (!((((_la) & ~0x3f) == 0
						&& ((1L << _la) & ((1L << T__1) | (1L << T__40) | (1L << T__41) | (1L << T__42) | (1L << T__43)
	...
	public final ArithOpContext arithOp() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_la = _input.LA(1);
				if (!((((_la) & ~0x3f) == 0
						&& ((1L << _la) & ((1L << T__1) | (1L << T__46) | (1L << T__47) | (1L << T__48) | (1L << T__49)
								| (1L << T__50) | (1L << T__51) | (1L << T__52) | (1L << T__53))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
	...
	public final ArithOp2Context arithOp2() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(502);
				_la = _input.LA(1);
				if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__54) | (1L << T__55) | (1L << T__56)
						| (1L << T__57) | (1L << T__58) | (1L << T__59))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
	...
	public static class QualifiedContext extends ParserRuleContext {
		...
		@Override
		public int getRuleIndex() {
			return RULE_qualified;
		}

		@Override
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).enterQualified(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).exitQualified(this);
		}
	}
	...
	public static class ArithComplexExprContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).enterArithComplexExpr(this);
		}
	...
	public final InfixSetOpContext infixSetOp() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				setState(643);
				_la = _input.LA(1);
				if (!(((((_la - 53)) & ~0x3f) == 0 && ((1L << (_la - 53))
						& ((1L << (T__52 - 53)) | (1L << (T__63 - 53)) | (1L << (T__64 - 53)))) != 0))) {
					_errHandler.recoverInline(this);
				} else {
					consume();
				}
	...
	public static class SimpleNonEmptyListContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).enterSimpleNonEmptyList(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).exitSimpleNonEmptyList(this);
		}
	}
	...
	public static class NonEmptyListElemsContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).enterNonEmptyListElems(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof MiniZincGrammarListener)
				((MiniZincGrammarListener) listener).exitNonEmptyListElems(this);
		}
	}
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3]\u0365\4\2\t\2\4"
